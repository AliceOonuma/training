...
import jp.genuine.training.carmanager.base.datasource.infrastructure.mybatis.LocalDateHandler;
import jp.genuine.training.carmanager.base.datasource.infrastructure.mybatis.LocalDateTimeHandler;


public class MyBatisConfig {

	@Configuration
	@MapperScan(basePackages = {"jp.genuine.training.carmanager.datasource.sampledb"}, sqlSessionFactoryRef = "sampleSqlSessionFactory")
